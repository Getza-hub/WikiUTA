<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Maneja tus sesiones activas de navegador y dispositivos.') }}
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Si es necesario, puedes cerrar sesión en todos los dispositivos mostrados aquí.  Si sientes que tu cuenta no esta segura, actualiza tu contraseña.') }}
        </div>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Por favor, ingresa tu contraseña para cerrar tu cuenta en otros dispositivos y navegadores') }}
